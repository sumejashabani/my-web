...
const FacePage = () => {
    ...
    const FaceProducts = [
        { id: 4, name: 'Hydrating Foundation', description: 'Long-lasting foundation that keeps your skin hydrated.', price: '$30', img: require('./foundation.jpg') },
        ...
        { id: 7, name: 'Glow Bronzer', description: 'Enhance your features with radiant sun-kissed look.', price: '$19.79', img: require('./bronzer.jpeg') },
    ];
    ...
    return (
        <>
            ...
            <div className="face-page-container">
                <h1 className="face-page-title">Face Products</h1>
